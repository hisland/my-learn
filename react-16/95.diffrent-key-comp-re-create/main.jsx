    ...
    return (
      <div>
        ...
        <div style={{ border: '1px solid pink', margin: '10px' }}>
          ...
          {this.state.count % 3 === 0 && <Sub1 key="1" some="1"></Sub1>}
          {this.state.count % 3 === 1 && <Sub1 key="2" some="2"></Sub1>}
          {this.state.count % 3 === 2 && <Sub1 key="3" some="3"></Sub1>}
        </div>
      </div>
    )
  }
