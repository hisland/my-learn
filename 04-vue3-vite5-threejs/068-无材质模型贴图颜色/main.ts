...
const box1 = await loader.loadAsync('../static/box-test/Cube_004无材质.fbx')
const textureLoader = new THREE.TextureLoader()
const texture1 = await textureLoader.loadAsync('../static/box-test/交换机-默认.png')
const texture2 = await textureLoader.loadAsync('../static/box-test/normal.png')
// Cube_001纯色.fbx
// Cube_004全贴图.fbx
// Cube_004无材质.fbx
// Cube_004贴图加纯色.fbx
...
function setModel(fbxModel: THREE.Group, texture1: THREE.Texture, texture2: THREE.Texture) {
...
setModel(box1, texture1, texture2)
...
{
  // 环境光
  const ambientLight = new THREE.AmbientLight(0xffffff, 5) // 环境光，提供柔和的整体光照
