...
onMounted(() => {
  ...
  graphRef.on('edge:mouseenter', (obj) => {
    obj.edge.addTools([
      {
        name: 'button-remove',
        args: {},
  ...
  graphRef.on('edge:mouseleave', (obj) => {
    obj.edge.removeTools()
  })
  graphRef.on('edge:added', (obj) => {
    console.log('edge:added obj.edge: ', obj.edge)
  })
  graphRef.on('edge:removed', (obj) => {
    console.log('edge:removed obj.edge: ', obj.edge)
  })
